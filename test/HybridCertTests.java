...
public class HybridCertTests {
    ...
    @Test
    void testSelfSig() throws IOException, CertificateException {
        AsymmetricCipherKeyPair secondary = createQTESLAKeyPair();
        AsymmetricCipherKeyPair primary = createRSAKeyPair();
        X509Certificate cert = createCertificate("CA1", "CA1", primary, secondary, primary.getPrivate(), (QTESLAPrivateKeyParameters) secondary.getPrivate());
        assertNotNull(cert);
    ...
    void testCASig() throws IOException, CertificateException {
        AsymmetricCipherKeyPair CAsecondary = createQTESLAKeyPair();
        AsymmetricCipherKeyPair CAprimary = createRSAKeyPair();
        AsymmetricCipherKeyPair EEsecondary = createQTESLAKeyPair();
        AsymmetricCipherKeyPair EEprimary = createRSAKeyPair();
        X509Certificate cert = createCertificate("EE", "CA1", EEprimary, EEsecondary, CAprimary.getPrivate(), (QTESLAPrivateKeyParameters) CAsecondary.getPrivate());
        assertNotNull(cert);
    ...
    void verifyCertChain() throws CertificateException, InvalidAlgorithmParameterException, CertPathValidatorException {
        AsymmetricCipherKeyPair CA1secondary = createQTESLAKeyPair();
        AsymmetricCipherKeyPair CA2secondary = createQTESLAKeyPair();
        AsymmetricCipherKeyPair EEsecondary = createQTESLAKeyPair();
        ...
        X509Certificate EEcert = createCertificate("EE", "CA2", EEprimary, EEsecondary, CA2primary.getPrivate(), (QTESLAPrivateKeyParameters) CA2secondary.getPrivate());
